...
export default function Sec({ navigation }) {  
    ...
    return (
      <View style={{ flex: 1 }}>
        <DrawerContentScrollView {...props}>
          ...
          >
            <View>
              <Text style={{fontSize: 20,fontWeight: 'bold', color: 'gray'}}>React Native Components</Text>
            </View>
  ...
  return (
    <VStack style={{backgroundColor: '#272829', flex: 1}}>
      <GluestackUIProvider>
          <NavigationContainer >
              <Drawer.Navigator drawerContent={props => <CustomDrawer {...props} />} screenOptions={{headerStyle:{ backgroundColor: 'white'}, drawerStyle:{backgroundColor: '#ffffff'}}} >
